...
class HomeTests(TestCase):
    ...
    def test_home_view_contains_link_to_topics_page_view(self):
...
class BoardTopicsTests(TestCase):
    ...
    # def test_board_topics_view_contains_link_back_to_homepage_view(self):
